...
//////////
	...
	//////////
			...
			// save
			this.els.titlebar.buttons.save = document.createElement("li");
			this.els.titlebar.buttons.save.id = this.els.titlebar.buttons.ul.id+'-save';
			this.els.titlebar.buttons.save.className = 'button';
			this.els.titlebar.buttons.save.title = 'Save changes';
			this.els.titlebar.buttons.save.innerHTML = '<img src="images/icon-save.png">';
			$(this.els.titlebar.buttons.ul.id).addChild(this.els.titlebar.buttons.save);
			
			// save action
			$(this.els.titlebar.buttons.save.id).click(function(){
				self.db.write();
			});
